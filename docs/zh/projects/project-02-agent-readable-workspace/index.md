...
仓库路径：`projects/project-02/`

| 目录 | 里面有什么 | 比较什么 |
|------|------|------|
| `starter/` | Project 01 代码，加上未完成的文档导入、详情视图、持久化。文档存在但较薄，没有 `session-handoff.md`。 | 第二个 agent 会话要重新发现多少上下文。 |
| `solution/` | 完成同一产品切片，并在 `projects/project-02/solution/` 下补齐核心文档（以及 `feature_list.json`、`session-handoff.md`）。 | 新会话能否只靠仓库状态继续工作。 |
